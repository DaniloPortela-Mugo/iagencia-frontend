...
const DISPATCH_OPTIONS = [
  ...
  { id: "producao", label: "Vídeo (RTV)", color: "bg-emerald-500", text: "text-emerald-50" },
  // Social não possui kanban próprio: direciona para Redação
  { id: "social_media", label: "Social", color: "bg-pink-500", text: "text-pink-50", mapsTo: "social_media" },
];
...
export default function Atendimento() {
  ...
  const [references, setReferences] = useState(""); // Lista de Referências
  ...
  const handleGenerateBriefing = async () => {
      ...
      try {
          ...
          setBriefingResult({ ...data, deliverables }); 
  ...
  return (
    ...
    <div className="flex flex-col lg:flex-row gap-8">
        ...
        <div className="flex-1 space-y-6">
                ...
                <div className="space-y-6 animate-in slide-in-from-right-4 duration-500 pb-20">
                    ...
                    <div className="bg-zinc-900 border border-zinc-800 rounded-3xl overflow-hidden shadow-2xl">
                        <div className="bg-blue-600/10 border-b border-zinc-800 p-4 flex justify-between items-center">
                            ...
                            <Badge className="bg-blue-600 text-[9px] uppercase font-black">Sugestão IA V1</Badge>
                        </div>
                        ...
                        <div className="p-6 space-y-6">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div className="space-y-2">
                                    ...
                                    <div className="bg-black border border-zinc-800 p-3 rounded-xl space-y-1">
                                        {getDeliverables(briefingResult?.deliverables).map((item: string, i: number) => (
                          ...
                          {DISPATCH_OPTIONS.map((opt) => {
                            ...
                            return (
                              ...
                              >
                                ...
                                {opt.id === "producao" && <Video className="w-3 h-3 mr-2" />}
            ...
            <TabsContent value="historico"><div className="h-[400px] flex items-center justify-center text-zinc-500 border border-dashed border-zinc-800 rounded-xl">Histórico de jobs arquivados.</div></TabsContent>
        </Tabs>
      </div>
